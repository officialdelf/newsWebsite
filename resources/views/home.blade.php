        ...
        <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-2 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-0 px-lg-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                    ...
                    <a href="index.html" class="nav-item nav-link">{{$category->name}}</a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="position-relative mb-3">
                        <img class="img-fluid w-100" src="news/{{ $front->image1}}" style="object-fit: cover;">
                        <div class="bg-white border border-top-0 p-4">
                            ...
                            <div class="mb-3">
                                ...
                                <a class="text-body" href="">{{ $front->title}}</a>
                            </div>
                            ...
                            <img class="img-fluid w-50 float-left mr-4 mb-2" src="news/{{ $front->image1}}">
                            ...
                            <p>Diam dolor est labore duo invidunt ipsum clita et, sed et lorem voluptua tempor
                                ...
                                rebum consetetur, sanctus labore sed nonumy diam lorem amet eirmod. No at tempor
                                sea diam kasd, takimata ea nonumy elitr sadipscing gubergren erat. Gubergren at
                                lorem invidunt sadipscing rebum sit amet ut ut, voluptua diam Clita dolor amet dolor ipsum vero ea ea eos. Invidunt sed diam
                                dolores takimata dolor dolore dolore sit. Sit ipsum erat amet ldolores at
                                sadipscing stet. orem et, magna
                                sea at sed et eos. Accusam eirmod kasd lorem clita sanctus ut consetetur et. Et
            ...
            <div class="mb-3">
                ...
                @foreach ($side as $side )
                 <img class="img-fluid w-100" src="news/{{ $side->image1}}" style="object-fit: cover;">
                 <h4 class="m-0 text-uppercase font-weight-bold">{{ $side->category }}</h4>
                 <h4 class="m-0 text-uppercase font-weight-bold">{{ $side->title }}</h4>
                 @endforeach
