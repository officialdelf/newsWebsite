...
endforeach -->
    ...
    <div class="container-fluid">
        ...
        <div class="row d-flex">
            <div class="col-md-9 front-main">
                @foreach ($news as $item)
                    <a href="{{ url('/details', $item->id) }}" class="nav-item nav-link">
                        <h2 class="m-0 text-uppercase font-weight-bold">{{ $item->title }}</h2>

                        <img class="img-fluid w-100" src="news/{{ $item->image1 }}">
                        <div class="content">
